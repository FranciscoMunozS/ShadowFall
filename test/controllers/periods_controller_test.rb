...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post periods_url, params: { period: { end_date: @period.end_date, quantity: @period.quantity, resolution: @period.resolution, start_date: @period.start_date, working_day: @period.working_day } }
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { end_date: @period.end_date, quantity: @period.quantity, resolution: @period.resolution, start_date: @period.start_date, working_day: @period.working_day } }
